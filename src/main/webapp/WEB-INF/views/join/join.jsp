            ...
            <form name="join_form" action="join" method="post">
                <div class="join_form">
                    <div>
                        ...
                        <input type="text" id="user_id" class="id_input" name="user_id" minlength="4" maxlength="12" pattern="[a-zA-Z0-9]{4,12}" placeholder="4~12자의 영문,숫자로만 입력">
                        <span id="id_check_msg"></span>
                        <span class="idUseO">사용 가능한 아이디입니다.</span>
                        <span class="idUseX">이미 존재하는 아이디입니다.</span>
                    </div>
                    <div>
                    ...
                    <div>
                        ...
                        <span id="pwC_check_msg"></span>
                    </div>
                    <div>
                        <span class="form_name">닉네임</span>
                        <input type="text" id="user_name" class="name_input" name="user_name" placeholder="닉네임을 입력하세요">
                        <span id="name_check_msg"></span>
                        <span class="nameUseO">사용 가능한 닉네임입니다.</span>
                        <span class="nameUseX">이미 존재하는 닉네임입니다.</span>
                    </div>
                    <div>
                        <span class="form_name">성별</span>
                        <select name="gender" id="user_gen" class="name_input">
                            <option value="">선택</option>
                            <option value="gen_w">여자</option>
                            <option value="gen_m">남자</option>
                        </select>
                        <span id="gen_check_msg"></span>
                    </div>
                </div>
                <div class="join_btn">
